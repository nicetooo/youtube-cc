export const messages = {
  en: {
    ...
    language_upper: "Upper",
    language_lower: "Lower",
    auto_generated: "Auto",
    no_translation: "None",
  ...
  hi: {
    ...
    caption_language: "भाषा",
    language_upper: "ऊपर",
    language_lower: "नीचे",
    auto_generated: "स्वतः",
    no_translation: "कोई नहीं",
    no_captions: "कोई कैप्शन उपलब्ध नहीं",
  },
  es: {
    ...
    caption_language: "Idioma",
    language_upper: "Superior",
    language_lower: "Inferior",
    auto_generated: "Auto",
    no_translation: "Ninguno",
    no_captions: "Sin subtítulos disponibles",
  },
  fr: {
    ...
    caption_language: "Langue",
    language_upper: "Haut",
    language_lower: "Bas",
    auto_generated: "Auto",
    no_translation: "Aucune",
    no_captions: "Aucun sous-titre disponible",
  },
  ar: {
    ...
    font_size: "حجم الخط",
    caption_language: "اللغة",
    language_upper: "أعلى",
    language_lower: "أسفل",
    auto_generated: "تلقائي",
    no_translation: "بدون",
    no_captions: "لا توجد ترجمات",
  },
  bn: {
    ...
    font_size: "ফন্ট সাইজ",
    caption_language: "ভাষা",
    language_upper: "উপরে",
    language_lower: "নীচে",
    auto_generated: "স্বয়ংক্রিয়",
    no_translation: "কিছুই নয়",
    no_captions: "কোনো ক্যাপশন নেই",
  },
  pt: {
    ...
    language_lower: "Inferior",
    auto_generated: "Auto",
    no_translation: "Nenhum",
    no_captions: "Sem legendas disponíveis",
  },
  ru: {
    ...
    language_upper: "Верхний",
    language_lower: "Нижний",
    auto_generated: "Авто",
    no_translation: "Нет",
    no_captions: "Субтитры недоступны",
  },
};
