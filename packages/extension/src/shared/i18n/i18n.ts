export const messages = {
  en: {
    ...
    word_selection_sub: "Translate and save words on any page",
    target_language: "Target Language",
    target_language_sub: "Translation target language",
    save_word: "Save",
  ...
  zh_CN: {
    ...
    font_size: "字体大小",
    word_selection: "划词翻译",
    word_selection_sub: "在任意网页上翻译并保存生词",
    target_language: "目标语言",
    target_language_sub: "翻译的目标语言",
    save_word: "保存",
  ...
  zh_TW: {
    ...
    font_size: "字體大小",
    word_selection: "劃詞翻譯",
    word_selection_sub: "在任意網頁上翻譯並保存生詞",
    target_language: "目標語言",
    target_language_sub: "翻譯的目標語言",
    save_word: "保存",
  ...
  ja: {
    ...
    font_size: "フォントサイズ",
    word_selection: "選択翻訳",
    word_selection_sub: "任意のページで単語を翻訳して保存",
    target_language: "ターゲット言語",
    target_language_sub: "翻訳先の言語",
    save_word: "保存",
  ...
  ko: {
    ...
    word_selection_sub: "모든 페이지에서 단어를 번역하고 저장",
    target_language: "대상 언어",
    target_language_sub: "번역 대상 언어",
    save_word: "저장",
