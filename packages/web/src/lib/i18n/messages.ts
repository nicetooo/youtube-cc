...
export const messages = {
  en: {
    ...
    stats_activity_total: "{count} words added this year",
  ...
  zh_CN: {
    ...
    stats_activity_total: "今年添加了 {count} 个单词",
  ...
  zh_TW: {
    ...
    stats_activity_total: "今年添加了 {count} 個單字",
  ...
  ja: {
    ...
    stats_activity_total: "今年 {count} 単語を追加",
  ...
  ko: {
    ...
    stats_activity_total: "올해 {count}개 단어 추가",
  ...
  hi: {
    ...
    stats_activity_total: "इस वर्ष {count} शब्द जोड़े",
  ...
  es: {
    ...
    stats_activity_total: "{count} palabras añadidas este año",
  ...
  fr: {
    ...
    stats_activity_total: "{count} mots ajoutés cette année",
  ...
  ar: {
    ...
    stats_activity_total: "تم إضافة {count} كلمة هذا العام",
  ...
  bn: {
    ...
    stats_activity_total: "এই বছরে {count}টি শব্দ যোগ করা হয়েছে",
  ...
  pt: {
    ...
    stats_activity_total: "{count} palavras adicionadas este ano",
  ...
  ru: {
    ...
    stats_activity_total: "Добавлено {count} слов в этом году",
